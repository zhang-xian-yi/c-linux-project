...
extern bool stack_destory(pStack  pstack);
extern void stack_grow(pStack pstack);
extern pStack stack_create(uint32 alloc_num,uint32 elemsize, void (* freefn)(void *));
extern void* stack_pop(pStack pstack);
extern void stack_push(pStack pstack,pNode  elemaddr);
extern bool stack_empty(pStack pstack);
extern void* stack_peek(pStack pstack);
extern bool stack_clear(pStack pstack);
